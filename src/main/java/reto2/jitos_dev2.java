...
import static reto2.jitos_dev2.Player.P1;
import static reto2.jitos_dev2.Player.P2;
    ...
    private static List<Marker> match(Player[] secuence) {
        ...
        for (Player player: secuence) {
            ...
            if (player == P1) {
                ...
                //Almacenamos la nueva puntuación que es el valor que tiene la puntuación actual más uno en el array
